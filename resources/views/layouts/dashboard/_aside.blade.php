    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{ route('dashboard.users.index') }}"><i
                        class="fa fa-users"></i><span>@lang('site.users')</span></a>
            </li>

            @endif

            <li><a href="{{ route('dashboard.departments.index') }}"><i
                        class="fa fa-th-list"></i><span>@lang('site.departments')</span></a></li>

            <li><a href="{{ route('dashboard.news.index') }}"><i
                        class="fa fa-newspaper-o"></i><span>@lang('site.news')</span></a></li>
            {{----}}
            {{----}}
            {{--<li><a href="{{ route('dashboard.users.index') }}"><i
